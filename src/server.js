...
const options = {
  key: fs.readFileSync('/etc/letsencrypt/live/glimpmapss.canadacentral.cloudapp.azure.com/privkey.pem'),
  cert: fs.readFileSync('/etc/letsencrypt/live/glimpmapss.canadacentral.cloudapp.azure.com/fullchain.pem')
};
