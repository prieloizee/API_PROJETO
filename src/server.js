...
const options = {
  key: fs.readFileSync('/etc/letsencrypt/live/priscila-api.canadacentral.cloudapp.azure.com/privkey.pem'),
  cert: fs.readFileSync('/etc/letsencrypt/live/priscila-api.canadacentral.cloudapp.azure.com/fullchain.pem')
};
